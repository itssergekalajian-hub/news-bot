...
minutes of breaking rather than arriving in a big batch.

This frequent cadence is affordable because the repo is **public** — public
repos get unlimited free GitHub Actions minutes. If you ever switch it back
to private, widen the schedule interval: private repos have a metered
~2000-minute monthly allowance, and running every 5 minutes would exhaust it
in a couple of days and then halt all runs until the quota resets.
